...
if [ -z "$NETHACKOPTIONS" ]; then
  ...
  REPOSITORY_LIST+=" cloud ebooks hoople hoople1 hoople2 inova_codebase quartz web yeti xsede/xsede_tests xsede/code/cak0l xsede/docs xsede/secrets xsede/code/genesis/trunk xsede/code/genesis/libraries"
